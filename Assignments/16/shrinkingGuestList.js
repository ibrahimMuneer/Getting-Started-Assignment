...
for (var i = 0; i < myGuests.length + 1; i++) {
    if (myGuests.length > 2) {
        console.log("Sorry my friend ".concat(myGuests.pop(), ", we are unable to invite you for tonight's dinner."));
    }
}
;
for (var i = 0; i < myGuests.length; i++) {
    console.log("Hello ".concat(myGuests[i], " you are still invited to the dinner tonight."));
}
;
do {
    myGuests.shift();
